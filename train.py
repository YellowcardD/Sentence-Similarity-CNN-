...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        cnn = TextCNN(sequence_length=FLAGS.seq_length, num_classes=FLAGS.num_classes,
        ...
        # Outpu directory for models and summaries
        ...
        def train_step(s1, s2, score):
            ...
            """
            feed_dict = {cnn.input_s1: s1, cnn.input_s2: s2, cnn.input_y: score,
                         cnn.dropout_keep_prob: FLAGS.dropout_keep_prob}
            _, step, summaries, loss, pearson = sess.run([train_op, global_step, train_summary_op, cnn.loss,
                                                         cnn.pearson], feed_dict)
        ...
        def dev_step(s1, s2, score, writer=None):
            ...
            """
            feed_dict = {cnn.input_s1: s1, cnn.input_s2: s2, cnn.input_y: score, cnn.dropout_keep_prob: 1.0}
